...
| `unitTestUseMicrosoftTestingPlatform` | boolean | `true` | Unit test runner mode: `true` for Microsoft Testing Platform (modern CLI with TRX/Cobertura), `false` for legacy `dotnet test` with VSTest and XPlat Code Coverage |
